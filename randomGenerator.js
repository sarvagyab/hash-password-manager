...
export const passwordGenerator = {
  ...
  generate(
    ...
    const lengthLower = this._randomIndex(length - minLengthLower - minLengthUpper - minLengthDigit - minLengthSpecial) + minLengthLower;
...
// // example use
// console.log(passwordGenerator.generate(-1));
