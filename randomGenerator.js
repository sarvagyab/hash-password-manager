...
const REQUIRED_CHARACTER_SETS = [LOWER_CASE,UPPER_CASE,DIGITS];
...
this.passwordGenerator = {
    ...
    generatePassword(length = DEFAULT_PASSWORD_LENGTH) {
        ...
        let lengthDigit = length - lengthLower - lengthUpper;

        let lenghtOfRequiredCharacterSets = [lengthLower,lengthUpper,lengthDigit];


        for(const [idx,charSetString] of REQUIRED_CHARACTER_SETS.entries()){
            while(lenghtOfRequiredCharacterSets[idx]--){
